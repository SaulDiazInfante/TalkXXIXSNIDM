...
\titlegraphic{\vspace{-2em}\hfill\includegraphics[scale=.05]{logoSemanaxxixUnison.png}}
\metroset{block=fill}
\input{setup}
\author[Sa\'ul D\'iaz Infante Velasco]{
...
\begin{document}
    ...
    \section{Control policies in epidemics}
        \include{control_policies}
        \include{example_sars}
    \section{Existence and characterization of optimal policies}
        \include{existence_char_op}
        \include{pontryagin}
    \section{Numerical analysis}
    	\include{intro_numerics}
        \include{example_numerics}
    \section{Concluding remarks}
        \include{conclude_remarks}
